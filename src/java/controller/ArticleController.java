/**
 * Контроллер управляет добавлением, редактированием и удалением объявлений
 * Для добавления необходимо быть авторизованным пользователем
 * Пользователи могут редактировать и удалять свои объявления, администраторы - любые
 */
package controller;
